      ...
      <div className="bg-white rounded-lg p-8 shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <textarea id="content" name="content" value={post.content} onChange={handleChange} rows={4} className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter post content" />
          </div>
